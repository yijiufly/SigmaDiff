1: 
2: void FUN_0014a8b0(code **param_1,byte *param_2)
3: 
4: {
5: char **ppcVar1;
6: long *plVar2;
...
32: }
33: if (lVar15 < lVar13) {
34: *(long *)(pcVar4 + 0x18) = *(long *)(pcVar4 + 0x18) + lVar15;
35: *(long *)(pcVar4 + 0x20) = lVar13;
36: }
...
68: }
69: else {
70: if (iVar12 < 0) goto LAB_0014a9ef;
...
93: plVar2 = plVar8 + 1;
94: *plVar2 = *plVar2 + -1;
95: if ((*plVar2 != 0) || (iVar12 = (*(code *)plVar8[3])(), iVar12 != 0)) goto LAB_0014a9ef;
