1: 
2: undefined8 FUN_00168fb0(code **param_1,long param_2)
3: 
4: {
5: int iVar1;
6: int iVar2;
...
28: iVar2 = *(int *)(&DAT_00190860 + uVar11 * 4);
29: lVar19 = (long)*(int *)(&DAT_00190800 + uVar11 * 4);
30: iVar3 = *(int *)(&DAT_001907a0 + uVar11 * 4);
31: iVar4 = *(int *)(&DAT_001906e0 + uVar11 * 4);
32: iVar5 = *(int *)(&DAT_00190740 + uVar11 * 4);
33: sVar12 = fread(*(void **)(param_2 + 0x30),1,*(size_t *)(param_2 + 0x40),*(FILE **)(param_2 + 0x18)
34: );
35: if (*(size_t *)(param_2 + 0x40) != sVar12) {
...
44: if (iVar4 < 0) {
45: if (iVar6 != 0) {
46: pbVar13 = (byte *)(lVar9 + iVar2);
47: pbVar15 = pbVar10;
48: do {
49: pbVar14 = pbVar15 + 3;
50: *pbVar13 = *pbVar15;
51: pbVar17 = pbVar13 + -(long)iVar2;
52: pbVar13 = pbVar13 + iVar5;
53: pbVar17[lVar19] = pbVar15[1];
...
59: else {
60: if (iVar6 != 0) {
61: pbVar13 = (byte *)(lVar9 + iVar2);
62: pbVar15 = pbVar10;
63: do {
64: pbVar14 = pbVar15 + 3;
65: *pbVar13 = *pbVar15;
66: pbVar17 = pbVar13 + -(long)iVar2;
67: pbVar13 = pbVar13 + iVar5;
68: pbVar17[lVar19] = pbVar15[1];
...
78: if (iVar6 != 0) {
79: pbVar15 = pbVar10;
80: puVar18 = (undefined *)(lVar9 + iVar2);
81: do {
82: pbVar13 = pbVar15 + 3;
83: *puVar18 = *(undefined *)(lVar7 + (ulong)*pbVar15);
84: (puVar18 + -(long)iVar2)[lVar19] = *(undefined *)(lVar7 + (ulong)pbVar15[1]);
85: (puVar18 + -(long)iVar2)[iVar3] = *(undefined *)(lVar7 + (ulong)pbVar15[2]);
86: pbVar15 = pbVar13;
...
92: if (iVar6 != 0) {
93: pbVar15 = pbVar10;
94: puVar18 = (undefined *)(lVar9 + iVar2);
95: do {
96: pbVar13 = pbVar15 + 3;
97: *puVar18 = *(undefined *)(lVar7 + (ulong)*pbVar15);
98: puVar16 = puVar18 + -(long)iVar2;
99: puVar16[lVar19] = *(undefined *)(lVar7 + (ulong)pbVar15[1]);
