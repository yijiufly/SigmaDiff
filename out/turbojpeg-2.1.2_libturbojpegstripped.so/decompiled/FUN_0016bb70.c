1: 
2: void FUN_0016bb70(long param_1,long param_2)
3: 
4: {
5: int iVar1;
6: int iVar2;
...
18: iVar2 = *(int *)(&DAT_00190b80 + uVar6 * 4);
19: iVar3 = *(int *)(&DAT_00190b20 + uVar6 * 4);
20: iVar4 = *(int *)(&DAT_00190ac0 + uVar6 * 4);
21: iVar5 = *(int *)(&DAT_00190a60 + uVar6 * 4);
