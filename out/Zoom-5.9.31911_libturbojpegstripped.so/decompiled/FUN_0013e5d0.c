1: 
2: void FUN_0013e5d0(code **param_1,byte *param_2,int param_3)
3: 
4: {
5: long *plVar1;
6: byte bVar2;
...
27: if ((int)(uint)bVar2 >> 7 == param_3) {
28: if (0x7fff < lVar11) {
29: return;
30: }
31: if (lVar11 < lVar15) {
32: *(long *)(pcVar3 + 0x18) = *(long *)(pcVar3 + 0x18) + lVar11;
33: *(long *)(pcVar3 + 0x20) = lVar15;
34: }
35: *param_2 = bVar2 & 0x80 ^ (byte)((ulong)lVar12 >> 8);
36: }
37: else {
38: if (lVar15 <= lVar11) {
...
41: }
42: *param_2 = bVar2 & 0x80 ^ (byte)lVar12;
43: }
...
78: *plVar1 = *plVar1 + -1;
79: if (*plVar1 == 0) goto LAB_0013e942;
80: }
...
146: *plVar1 = *plVar1 + -1;
147: if (*plVar1 == 0) goto LAB_0013e870;
148: }
...
177: *plVar1 = *plVar1 + -1;
178: if (*plVar1 == 0) goto LAB_0013e77a;
179: }
