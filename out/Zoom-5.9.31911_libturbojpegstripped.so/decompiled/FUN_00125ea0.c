1: 
2: ulong FUN_00125ea0(long param_1,ulong param_2,int param_3,long param_4,int param_5)
3: 
4: {
5: long *plVar1;
6: int iVar2;
...
19: lVar4 = (long)param_5;
20: uVar3 = SEXT48((int)((1 << ((byte)param_5 & 0x1f)) - 1U &
21: (uint)(param_2 >> ((byte)param_3 & 0x3f))));
22: if (*(long *)(param_4 + lVar4 * 8) < (long)uVar3) {
23: do {
24: if (param_3 < 1) {
25: iVar2 = FUN_00125d30(param_1);
26: if (iVar2 == 0) {
